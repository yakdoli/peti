...
class MetadataManager:
    ...
    def __init__(self, metadata_dir: str | Path | None = None, load_existing: bool = True):
        ...
        default_metadata_dir = self.config.get_download_config().get('metadata_directory', 'artifacts/metadata')
        self.metadata_dir = Path(metadata_dir or default_metadata_dir)
